...
from team_dashboard.forms import TestTimeSplitForm, TestDateTimeForm, TestTrainingType
...
class TestTrainingType(SimpleTestCase):
    def test_form_submission(self):
       form_data={'training': 'Taekwondo',
                  'training_subtype': 'Paos'}
       form = TestTrainingType(form_data)

       self.assertTrue(form.is_valid())

       form_data={'training': 'Recovery',
                  'training_subtype': []}
       form = TestTrainingType(form_data)
