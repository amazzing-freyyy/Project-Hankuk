...
from team_dashboard.views import Athlete_Home, Coach_Home, WakeUpFormView, PostTrainingFormView, RedirectView, Wellness_Dashboard, profile
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(authentication_form=RememberMeForm), name='login'),
