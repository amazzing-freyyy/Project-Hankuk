...
class WakeUpForm(forms.Form):
    ...
    hours_of_sleep= TimeMultiField(attrs={'inputmode':'numeric'}, error_messages={'required':'Hace falta un valor en las horas de sueño'})
...
class PostTrainingForm(forms.Form):
    ...
    time_of_activity= forms.DecimalField(widget=forms.TextInput(attrs={'class': 'form-control', 'inputmode':'numeric'}), error_messages={'invalid':'Valor de tiempo inválido.','required':'Hace falta la duración de la actividad'})
